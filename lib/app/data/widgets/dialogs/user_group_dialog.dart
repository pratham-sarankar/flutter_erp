...
class UserGroupDialog extends StatefulWidget {
  const UserGroupDialog({Key? key, this.group}) : super(key: key);
  final UserGroup? group;
  @override
  State<UserGroupDialog> createState() => _UserGroupDialogState();
}

class _UserGroupDialogState extends State<UserGroupDialog> {
